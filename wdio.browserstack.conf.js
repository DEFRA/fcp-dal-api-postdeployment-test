...
export const config = {
  ...
  baseUrl: `https://fcp-dal-api-postdeployment-test.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `fcp-dal-api-postdeployment-test-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `fcp-dal-api-postdeployment-test-${process.env.ENVIRONMENT}`
        },
